    ...
    <section className="py-24 w-full bg-[#050507] relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto px-4 flex flex-col md:flex-row gap-12 lg:gap-20 items-center md:items-start relative z-10">
        ...
        <div className="w-full md:w-1/3 flex flex-col items-center">
          {/* Shadow Green */}
          <div className="w-full max-w-[320px] bg-[#0b0d15] p-8 rounded-2xl border border-gold-500/50 flex flex-col items-center relative overflow-hidden shadow-[0_0_30px_rgba(34,197,94,0.15)]">
             {/* Glow effect behind image - Green */}
             <div className="absolute top-0 inset-x-0 h-48 bg-gradient-to-b from-gold-500/20 to-transparent opacity-100"></div>
            
            {/* Shadow Green */}
            <div className="relative w-32 h-32 md:w-40 md:h-40 rounded-full overflow-hidden border-[3px] border-gold-500 mb-6 z-10 shadow-[0_0_20px_rgba(34,197,94,0.4)]">
        ...
        <div className="w-full md:w-2/3 space-y-6 text-gray-400 text-sm md:text-base leading-loose">
          <h2 className="text-2xl md:text-4xl font-bold text-white mb-4">
            {/* Drop Shadow Green */}
            A Jornada da Lotus rumo à <span className="text-gold-500 drop-shadow-[0_0_10px_rgba(34,197,94,0.5)]">Alta Performance Digital</span>
          </h2>
          ...
          {/* Shadow Green */}
          <div className="bg-[#0b0d15] border border-gold-500/20 p-6 rounded-lg mt-6 shadow-[0_0_15px_rgba(34,197,94,0.05)]">
